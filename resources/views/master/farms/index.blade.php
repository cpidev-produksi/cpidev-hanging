    ...
    <div class="page-header">
        <div class="page-title-group">
            ...
            <div>
                ...
                <p class="page-subtitle">Kelola seluruh farm</p>
            </div>
        </div>
            ...
            <table class="data-table">
                ...
                @forelse($farms as $f)
                    <tr>
                        <td>
                            <div class="farm-cell">
                                <div class="avatar">{{ strtoupper(substr($f->name, 0, 1)) }}</div>
                                <span class="farm-name">{{ $f->name }}</span>
                            </div>
                        </td>
                        <td class="action-cell">
                            <a href="{{ route('master.farms.edit', $f) }}" class="btn-icon-edit" title="Edit">
                            ...
                            <form method="POST" action="{{ route('master.farms.destroy', $f) }}" class="inline-form" onsubmit="return confirm('Hapus farm {{ $f->name }}?')">
                                @csrf @method('DELETE')
...
/* ===== PAGE LAYOUT ===== */
.farms-page { max-width: 1100px; margin: 0 auto; padding: 28px 20px; }
...
/* ===== CELLS ===== */
.farm-cell { display: flex; align-items: center; gap: 10px; }
...
.farm-name { font-weight: 600; color: var(--c-text); }
