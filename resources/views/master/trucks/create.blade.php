...
<div class="form-page">
    ...
    <div class="page-header">
        ...
        <div>
            <h1 class="page-title">Tambah Truk Baru</h1>
            <p class="page-subtitle">Isi formulir di bawah untuk menambahkan truk</p>
        </div>
    </div>

    {{-- Form Card --}}
    <form method="POST" action="{{ route('master.trucks.store') }}" class="form-card">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                <label class="form-label" for="no_truck">
                    No Truk
                ...
                <div class="input-wrapper @error('no_truck') has-error @enderror">
                    ...
                    <input id="no_truck" name="no_truck" type="text" value="{{ old('no_truck') }}"
            ...
            {{-- No Polisi --}}
            <div class="form-group">
                <label class="form-label" for="plate_number">
                    No Polisi (unik)
                    <span class="required">*</span>
                </label>
                <div class="input-wrapper @error('plate_number') has-error @enderror">
                    ...
                    <input id="plate_number" name="plate_number" type="text" value="{{ old('plate_number') }}"
            ...
            <div class="form-group full-width">
                <label class="form-label" for="expedition_id">
                    Ekspedisi
                    <span class="required">*</span>
                </label>
