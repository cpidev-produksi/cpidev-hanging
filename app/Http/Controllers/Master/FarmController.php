...
class FarmController extends Controller
{
    public function index() {
        $farms = Farm::query()->latest()->paginate(20);
        return view('master.farms.index', compact('farms'));
    }

    public function create() { return view('master.farms.create'); }
    ...
    public function edit(Farm $farm) { return view('master.farms.edit', compact('farm')); }
